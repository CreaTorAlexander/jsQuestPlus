...
// from the paper
// const contrast_samples = jsquest.linspace(-40, 0);
// const threshold_samples = jsquest.linspace(-40, 0);
// const slope_samples = jsquest.linspace(2, 5);
// const lapse_samples = jsquest.array(0, 0.01, 0.04);
// const guess = [0.5];

// from the github example to validate
const contrast_samples = jsquest.linspace(-40, 0) // [-40, -39, -38, ..., -1, 0]
const threshold_samples = jsquest.linspace(-40,0) // [-40, -39, -38, ..., -1, 0]
const slope_samples = [3.5] // Don't forget to add brackets, i.e., specify as an array.
const guess = [0.5]
...
// Create an instance of jsQuestPlus
...
// Example functions representing probabilities for responses
